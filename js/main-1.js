const IMG_PHOTO_FRAME_BG_SRC = './img/1/photo-frame-bg-green.png'
const IMG_15_OUT_PHOTO_FRAME_SRC = './img/1/15-out-photo-frame.png'
const IMG_15_IN_PHOTO_FRAME_SRC = './img/1/15-in-photo-frame.png'

const IMG_DEFAULT_YOUR_SRC = './img/1/transparent-225x103.png'
const IMG_FISH_SRC = './img/fish-1100x1500.png'

const CANVAS_WIDTH = 258
const CANVAS_HEIGHT = 222
const PHOTO_WIDTH = 225
const PHOTO_HEIGHT = 103
const PHOTO_X = 11
const PHOTO_Y = 8
